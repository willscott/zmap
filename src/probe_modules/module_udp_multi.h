...
typedef enum udp_multi_payload_field_type
{
	UDP_DATA,
...
typedef struct udp_multi_payload_field_type_def {
	const char *name;
	const char *desc;
	udp_multi_payload_field_type_t ftype;
} udp_multi_payload_field_type_def_t;

typedef struct udp_multi_payload_field
{
	enum udp_multi_payload_field_type ftype;
	unsigned int length;
	char *data;
} udp_multi_payload_field_t;

typedef struct udp_multi_payload_template
{
	unsigned int fcount;
	struct udp_multi_payload_field **fields;
} udp_multi_payload_template_t;

typedef struct udp_multi_payload_output
{
	int length;
	char *data;
} udp_multi_payload_output_t;
